...
html, body, #mapid {
	...
	<div style="padding-bottom: 40px">
		<div class="card m-2" data-toggle="modal" data-target="#news1">
			<div class="d-flex">
				<div class="p-2 text-center">
					<img src="image/karhutla.jpeg" width="100" height="100">
				</div>
				<div class="p-1">
					<div class="col">
		...
		<div class="card m-2" data-toggle="modal" data-target="#news2">
			<div class="d-flex">
				<div class="p-2 text-center">
					<img src="image/karhutla2.jpeg" width="100" height="100">
				</div>
				<div class="p-1">
					<div class="col">
		...
		<div class="card m-2" data-toggle="modal" data-target="#news3">
			<div class="d-flex">
				<div class="p-2 text-center">
					<img src="image/udara.jpeg" width="100" height="100">
				</div>
				<div class="p-1">
					<div class="col">
			...
			<div class="modal-content">
				...
				<div class="modal-header">
					<div class="mr-auto" style="margin-left: 20px;">
						<img width="30" src="icon/icon.png">
					</div>
				...
				<div class="modal-body">
					...
					<img src="image/karhutla.jpeg" width="100%">
					<p>&nbsp;&nbsp;&nbsp;&nbsp;Kebakaran hutan dan lahan (karhutla) di sejumlah wilayah di Pulau Sumatera makin menjadi-jadi. Titik api di sejumlah wilayah bertambah.</p>
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<img src="image/karhutla2.jpeg" width="100%">
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<img src="image/udara.jpeg" width="100%">
